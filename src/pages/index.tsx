...
export default function Home({ }: any) {
  ...
  return (
    <main className="container mx-auto">
      ...
      <Link className="fixed bottom-5 right-5 cursor-pointer transition ease-in-out delay-50 hover:scale-125 duration-300 bg-[url('/arrow-top-outlined-dark.svg')] hover:bg-[url('/arrow-top-filled-dark.svg')] dark:bg-[url('/arrow-top-outlined-light.svg')] dark:hover:bg-[url('/arrow-top-filled-light.svg')] bg-cover w-[40px] h-[40px]" href={`#${translator('inicio')}`} />
    </main>
  )
}