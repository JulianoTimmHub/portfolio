  ...
  return (
    <>
      <main className="container mx-auto">
        <section id="introduction" className="w-full flex items-center justify-center flex-col h-[100vh] max-[640px]:gap-[3rem]">
        ...
        <section id="projetos" className="w-full flex items-center justify-evenly flex-col mt-10 mb-10">
        ...
        <Link className="fixed bottom-5 right-5 cursor-pointer transition ease-in-out delay-50 hover:scale-125 duration-300 bg-[url('/back-to-top-outlined.svg')] hover:bg-[url('/back-to-top-filled.svg')] bg-cover w-[40px] h-[40px]" href="#inicio" />
      </main>
      <footer className="bg-white dark:bg-gray-900">
        <div className="container mx-auto py-8 lg:py-16 px-8 max-w-screen-md">
