...
export const SwitchLanguage = () => {
  ...
  return (
      <label className='themeSwitcherTwo shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-[#656783] p-1'>
        ...
        />
        <span 
          className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${languageSelected === 'pt-BR' ? 'hover:bg-[#303446]' : 'hover:bg-[#8689AD]'} ${
        ...
        <span onClick={() => handleChangeLanguage('en-US')}
          className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${languageSelected === 'en-US' ? 'hover:bg-[#303446]' : 'hover:bg-[#8689AD]'} ${
